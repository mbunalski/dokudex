export async function populateall ()  {
  ...
  export async function filtered (metric1, metric2)  {
    ...
    const pokemonm1 = await fetch(`https://database-dev.sc0cnr40cdhve.us-east-1.cs.amazonlightsail.com/type/${metric1}`);
    ...
    const pokemonm2 = await fetch(`https://database-dev.sc0cnr40cdhve.us-east-1.cs.amazonlightsail.com/type/${metric2}`);
